...
- Identify the root directory of the plugin (PLUGIN_ROOT), run `bash {PLUGIN_ROOT}/bin/softeng.sh action uchange [options]` and follow the instructions in the output how to process {description}.
